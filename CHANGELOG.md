...
- Add regressor prefix to columns generated by TimeFlagsTransform ([#126](https://github.com/tinkoff-ai/etna-ts/pull/126))
- Typo in lines with clustering and outliers notebook in changelog ([#137](https://github.com/tinkoff-ai/etna-ts/pull/137))
