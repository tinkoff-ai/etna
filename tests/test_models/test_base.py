...
def test_deep_base_model_raw_fit(
    ...
    trainer.return_value.fit.assert_called_with(
        deep_base_model_mock, train_dataloaders=dataloader.return_value, val_dataloaders=None
    )
...
def _test_deep_base_model_raw_fit_split_params(
    ...
    trainer.return_value.fit.assert_called_with(
        deep_base_model_mock, train_dataloaders=dataloader.return_value, val_dataloaders=dataloader.return_value
    )
    calls = [
