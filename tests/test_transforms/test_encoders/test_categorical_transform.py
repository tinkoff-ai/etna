...
def test_new_value_label_encoder(two_ts_with_new_values, strategy, expected_values):
...
def test_new_value_ohe_encoder(two_ts_with_new_values, expected_values):
