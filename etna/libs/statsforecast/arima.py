...
"""
# Note: Copied from statsforecast package (https://github.com/Nixtla/statsforecast/blob/v1.5.0/statsforecast/models.py)
# with removing prediction_intervals parameter and logic with it

from typing import List, Optional, Tuple

import numpy as np

from statsforecast.models import _TS, _add_fitted_pi
